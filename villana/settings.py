...
ALLOWED_HOSTS = ['*']
# Ajouter les hosts Render si nécessaire
...
TEMPLATES = [
    {
        ...
        'DIRS': [],  # si tu as des templates globaux, tu peux mettre [BASE_DIR / 'templates']
        'APP_DIRS': True,
        'OPTIONS': {
            'context_processors': [
...
STATICFILES_DIRS = [BASE_DIR / "media"]  # si tu mets tes fichiers ici
